...
import dataStructure.atomicNode;
import dataStructure.atomicNodelist;
import file.time;

public class callTaskDivision implements Callable <Long>{
	...
	public callTaskDivision(int id, /*List<RunReasoner> ReasonerPool, OWLOntologyManager manager, OWLOntology ontology, 
